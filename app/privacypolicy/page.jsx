        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="w-full md:w-1/2">
              <h1
                className={`text-3xl md:text-4xl  text-black ml-6 mt-6 ${lora.className}`}
              >
                Privacy Policy
              </h1>
            </div>
            ...
            <div className="w-full md:w-1/2 md:p-8 p-1">
              <div className="prose max-w-none text-black">
                <p className="text-sm mb-4">Last updated: May 06, 2025</p>
                ...
                <ul className="list-disc pl-5 mb-4 space-y-2">
                  ...
                  <li>
                    <strong>Application</strong> refers to Lagree Room, the
                    software program provided by the Company.
                  </li>
                  <li>
                    <strong>Company</strong> (referred to as either "the
                    Company", "We", "Us" or "Our" in this Agreement) refers to
                    Lagree Room Fitness Studio LTD, Unit 115 - 19979 76th Ave,
                ...
                <h2 className="text-xl font-semibold uppercase mt-6 mb-3">
                  Privacy Policies website article
                </h2>
                <h2 className="text-xl font-medium uppercase mt-6 mb-3">
                  We use both Session and Persistent Cookies for the purposes
                  set out below:
                </h2>
                <ul className="list-disc pl-5 mb-4 space-y-2">
                  <li className="text-2xl font-medium uppercase mt-6 mb-3">
                ...
                <p className="mb-4">
                  <strong>Mariana Tek</strong>
                </p>
                <p className="">Their Privacy Policy can be viewed at</p>
                <p className="mb-4 ">
                  https://www.xplortechnologies.com/privacy-notice/
                </p>

                <h2 className="text-xl font-semibold mt-6 mb-3">Payments</h2>
                <p className="mb-4">
